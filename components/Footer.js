            ...
            <div style={{ marginBottom: '3rem' }}>
              <Link href="/" style={{ display: 'flex', alignItems: 'center', gap: '0.2rem', textDecoration: 'none' }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', marginTop: '10px' }}>
                  <div style={{ fontFamily: 'var(--font-outfit)', fontSize: '1.6rem', color: 'white', letterSpacing: '1px', textTransform: 'uppercase', fontWeight: '800', lineHeight: '1' }}>
                    VISANIX <span style={{ color: 'var(--accent)', fontWeight: '600', textTransform: 'none', fontFamily: "var(--font-montserrat), sans-serif" }}>Global</span>
                  </div>
                  <div style={{
                    fontSize: '0.31rem',
                    color: 'var(--accent)',
          ...
          <div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '2.5rem' }}>
              ...
              <div style={{ display: 'flex', gap: '1.2rem', alignItems: 'flex-start' }}>
                <div style={{ width: '20px', height: '20px', color: 'white', marginTop: '4px' }}>
                  <svg fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path>
                  </svg>
                </div>
                <div style={{ display: 'flex', flexDirection: 'column', gap: '4px' }}>
                  <span style={{ color: 'rgba(255,255,255,0.6)', fontSize: '0.75rem', fontWeight: '800', textTransform: 'uppercase', letterSpacing: '1.5px' }}>Head of Operations & Business Development</span>
                  <a href="mailto:sahil@visanixglobal.com" style={{ color: 'white', fontSize: '1.1rem', fontWeight: '800', textDecoration: 'none', transition: 'var(--transition)' }}
              ...
              <div style={{ display: 'flex', gap: '1.2rem', alignItems: 'flex-start' }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '4px' }}>
                  <span style={{ color: 'rgba(255,255,255,0.6)', fontSize: '0.75rem', fontWeight: '800', textTransform: 'uppercase', letterSpacing: '1.5px' }}>Calls & WhatsApp Support</span>
                  <p style={{ color: 'white', fontSize: '1.1rem', fontWeight: '800', margin: 0 }}>+91 9667445766</p>
                </div>
              </div>
              ...
              <div style={{ display: 'flex', gap: '1.2rem', alignItems: 'flex-start' }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '4px' }}>
                   <span style={{ color: 'rgba(255,255,255,0.6)', fontSize: '0.75rem', fontWeight: '800', textTransform: 'uppercase', letterSpacing: '1.5px' }}>Corporate Office</span>
                  <p style={{ color: 'white', fontSize: '1.1rem', fontWeight: '800', lineHeight: '1.6', margin: 0 }}>
