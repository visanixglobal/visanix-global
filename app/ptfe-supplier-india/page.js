...
export const metadata = {
    title: 'PTFE Supplier in India | Visanix Global',
    description: 'Visanix Global supplies PTFE sheets, rods, tubes, gaskets and filled grades across India. B2B supplier for pharma, chemical and industrial manufacturers. Call +91 9667445766.',
    alternates: {
        canonical: '/ptfe-supplier-india',
    },
    openGraph: {
        title: 'PTFE Supplier in India | Visanix Global',
        description: 'Visanix Global supplies PTFE sheets, rods, tubes, gaskets and filled grades across India. B2B supplier for pharma, chemical and industrial manufacturers.',
        url: 'https://www.visanixglobal.com/ptfe-supplier-india',
    },
    twitter: {
        card: 'summary_large_image',
        title: 'PTFE Supplier in India | Visanix Global',
        description: 'Visanix Global supplies PTFE sheets, rods, tubes, gaskets and filled grades across India.',
        images: ['https://www.visanixglobal.com/og-image.png'],
    },
}

export default function PTFESupplierIndia() {
    const localBusinessSchema = {
        "@context": "https://schema.org",
        "@type": "LocalBusiness",
        "name": "Visanix Global",
        "description": "PTFE supplier across India, headquartered in Gurugram, Haryana",
    ...
    const faqSchema = {
        ...
        "mainEntity": [
            {
                "@type": "Question",
                "name": "Do you supply PTFE products across India?",
                "acceptedAnswer": { "@type": "Answer", "text": "Yes, Visanix Global supplies PTFE products across India and all major cities including Delhi NCR, Mumbai, Chennai, Ahmedabad, Pune, Hyderabad and more." }
            },
            {
                "@type": "Question",
            ...
            {
                "@type": "Question",
                "name": "How quickly can you deliver across India?",
    ...
    const breadcrumbSchema = {
        ...
        "itemListElement": [
            ...
            { "@type": "ListItem", "position": 2, "name": "PTFE Supplier in India", "item": "https://www.visanixglobal.com/ptfe-supplier-india" }
        ]
    }
    ...
    const cities = ['Mumbai', 'Delhi', 'Bengaluru', 'Chennai', 'Hyderabad', 'Pune', 'Ahmedabad', 'Kolkata', 'Surat', 'Jaipur', 'Gurugram', 'Noida', 'Faridabad', 'Chandigarh', 'Ludhiana']
                ...
                <section style={{ padding: '180px 0 80px', background: 'linear-gradient(135deg, var(--primary) 0%, #0a1b3d 100%)', color: 'white', position: 'relative', overflow: 'hidden' }}>
                    ...
                    <div className="container" style={{ position: 'relative', zIndex: 2 }}>
                        <nav style={{ marginBottom: '1.5rem', fontSize: '0.85rem', opacity: 0.7 }}>
                            ...
                            <span style={{ color: 'var(--accent)' }}>PTFE Supplier in India</span>
                        </nav>
                        <span style={{ color: 'var(--accent)', fontWeight: '800', textTransform: 'uppercase', letterSpacing: '3px', fontSize: '0.75rem' }}>Pan-India Supply</span>
                        <h1 style={{ color: 'white', fontSize: 'clamp(2.5rem, 5vw, 4rem)', marginTop: '1.25rem', marginBottom: '1.5rem' }}>
                            PTFE Supplier in <span className="gradient-text">India</span>
                        </h1>
                        <p style={{ color: 'rgba(255,255,255,0.75)', maxWidth: '650px', fontSize: '1.1rem', lineHeight: '1.7', fontFamily: 'var(--font-outfit), sans-serif' }}>
                            Visanix Global is a B2B specialty PTFE and engineering materials trading company headquartered in Gurugram, Haryana. We supply high-performance PTFE products to chemical plants, pharmaceutical manufacturers, and industrial OEM manufacturers across India and internationally.
                        </p>
                    </div>
                </section>
                    ...
                    <div className="container">
                        ...
                        <div style={{ marginBottom: '4rem' }}>
                            ...
                            <p style={{ fontSize: '1rem', lineHeight: '1.8', color: 'var(--text-main)', maxWidth: '800px', fontFamily: 'var(--font-outfit), sans-serif' }}>
                                Visanix Global is a trusted <strong>PTFE and Teflon supplier in India</strong>, headquartered in Sector 30, Gurugram, Haryana. As a leading <strong>virgin PTFE supplier in India</strong> and <strong>filled PTFE grades supplier</strong>, we supply rods, sheets, tubes, gaskets, bushes, rings, gland packing, and custom machined components to B2B customers across India. Our pan-India supply network covers all major industrial hubs including Mumbai, Chennai, Pune, Ahmedabad, Hyderabad, Bengaluru, Kolkata, and the entire Delhi NCR region. We also export internationally. As a <strong>fluoropolymer supplier in India</strong>, our customers include chemical processing plants, pharmaceutical manufacturers, food processing units, oil and gas companies, and industrial OEM manufacturers who require precision-grade engineering plastics with full material traceability and competitive pricing.
                            </p>
                        </div>

                        <div style={{ marginBottom: '4rem' }}>
                            <h2 style={{ fontSize: '2rem', marginBottom: '1.5rem' }}>PTFE Products We Supply <span style={{ color: 'var(--accent)' }}>Across India</span></h2>
                        ...
                        <div style={{ marginBottom: '4rem' }}>
                            <h2 style={{ fontSize: '2rem', marginBottom: '1.5rem' }}>Cities We Supply <span style={{ color: 'var(--accent)' }}>PTFE Products</span></h2>
                            <div style={{ display: 'flex', flexWrap: 'wrap', gap: '0.75rem' }}>
                                {cities.map((city, i) => (
                                    <span key={i} style={{ background: 'var(--primary)', color: 'var(--accent)', padding: '0.5rem 1.25rem', borderRadius: '100px', fontSize: '0.85rem', fontWeight: '700', fontFamily: 'var(--font-outfit), sans-serif' }}>{city}</span>
                                ))}
                            </div>
                        </div>

                        <div style={{ marginBottom: '4rem' }}>
                            <h2 style={{ fontSize: '2rem', marginBottom: '1.5rem' }}>Industries Served <span style={{ color: 'var(--accent)' }}>Across India</span></h2>
                        ...
                        <div style={{ marginBottom: '4rem' }}>
                            ...
                            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(260px, 1fr))', gap: '1.5rem' }}>
                                {[
                                    ...
                                    { icon: '🚚', title: 'Pan-India Delivery', text: 'Fast delivery to all major industrial cities across India via reliable logistics partners.' },
                        ...
                        <div style={{ marginBottom: '4rem' }}>
                            ...
                            <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem', maxWidth: '800px' }}>
                                {[
                                    { q: 'Do you supply PTFE products across India?', a: 'Yes, Visanix Global supplies PTFE products across India and all major cities including Delhi NCR, Mumbai, Chennai, Ahmedabad, Pune, Hyderabad and more.' },
                                    ...
                                    { q: 'How quickly can you deliver across India?', a: 'Delivery timelines depend on product type and quantity. Standard products are typically dispatched within 3-7 working days. Contact us for exact delivery timelines for your requirement.' },
                                ].map((faq, i) => (
                        ...
                        <div className="glass-card" style={{ background: 'var(--primary)', color: 'white', textAlign: 'center', padding: '4rem 2rem', border: 'none' }}>
                            <h3 style={{ color: 'white', fontSize: '2rem', marginBottom: '1rem' }}>Request a Quote — Pan-India Supply</h3>
                            <p style={{ color: 'rgba(255,255,255,0.7)', maxWidth: '500px', margin: '0 auto 2rem', fontFamily: 'var(--font-outfit), sans-serif' }}>
                                Tell us your PTFE requirement and delivery location. We will respond within 24 hours with pricing and availability.
                            </p>
